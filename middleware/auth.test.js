...
describe("authenticateJWT", function () {
	test("works: via header", function () {
		...
		//this has been provid103ed to show you another way to pass the token. you are only expected to read this code for this project.
...
describe("ensureLoggedIn", function () {
	...
	describe("ensureAdmin", function () {
		test("works", function () {
			expect.assertions(1);
			// console.log(expect.assertions(2));
			const req = {};
			const res = {
